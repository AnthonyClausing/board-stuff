...
```js
intersection([1,4,9,10,11], [2,3,4,5,8,10]);
 // should return [4, 10] (numbers can be in any order)
```

Follow-up example:

```js
intersection([5,4,1,7,2], [4,2,3,5]);
 // should return [5, 4, 2] (numbers can be in any order)
```
